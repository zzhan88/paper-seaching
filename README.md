...
1. **多源召回**：OpenAlex、PubMed、Crossref 并行检索，并在 PubMed、Crossref 增加目标期刊定向检索；单个来源失败不会中断其他来源。
...
7. **期刊分层**：主题准入通过后，优先选择 Nature/Science/Cell 系列、PNAS、JACS、Angew、ACS Central Science、Chemical Science、Advanced Science 等 Top 期刊，以及 ACS Catalysis 等高度对口专业期刊。JAFC、Green Chemistry、Bioresource Technology、Chemical Engineering Journal 等仅在应用场景吻合时获得高权重。
8. **多样性控制**：合格候选充足时优先保证至少 4 篇 Top 期刊论文；同一期刊优先最多 2 篇、同一技术赛道优先最多 4 篇。如果不足 10 篇，则从其余合格候选按总分补足，不对酶工程设置数量上限，也不以无关 Top 论文凑数。

每条推荐都会保存主题类别、技术赛道、期刊对口度、推荐理由，以及“主题/AI方法或酶工程/期刊/时效”分项得分，便于审查。

## 邮件阅读体验

- 首屏明确标注“酶工程 × AI for Protein”，并显示精选数量、Top 期刊数量和中文摘要数量。
- 目录可跳转到对应论文。
